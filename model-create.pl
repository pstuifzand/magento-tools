...
my @parts = (
    {
        ...
        model_uri  => $uri,
        filename   => $basedir . "/${module_name}/Model/${model_name}.php",
    },
    {
        class_name => "${module_name}_Model_Resource_${model_name}",
        template   => 'tt/model-resource.tt',
        model_uri  => $uri,
        filename   => $basedir . "/${module_name}/Model/Resource/${model_name}.php",
    },
    {
        class_name => "${module_name}_Model_Resource_${model_name}_Collection",
        template   => 'tt/model-collection.tt',
        model_uri  => $uri,
        filename   => $basedir . "/${module_name}/Model/Resource/${model_name}/Collection.php",
    }
);
